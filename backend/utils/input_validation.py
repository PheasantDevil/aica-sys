        ...
        for field, rules in schema.items():
            ...
            if field_type == str:
                ...
                if len(value) < min_length:
                    raise ValueError(f"Field '{field}' must be at least {min_length} characters long")
                
                if len(value) > max_length:
                    raise ValueError(f"Field '{field}' must be no more than {max_length} characters long")
...
VALIDATION_SCHEMAS = {
    ...
    "article_creation": {
        ...
        "content": {"type": str, "format": "html", "max_length": 50000, "required": True},
