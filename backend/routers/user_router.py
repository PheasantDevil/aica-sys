...
async def get_user_settings(
    ...
    try:
        ...
        settings = {
            ...
            "newsletter_subscription": getattr(current_user, 'newsletter_subscription', True),
...
async def get_user_stats(
    ...
    try:
        ...
        stats = UserStats(
            ...
            subscription_expires=subscription.current_period_end if subscription else None
        )
...
async def log_user_activity(
    ...
    try:
        ...
        logger.info(f"User activity: {current_user.email} - {activity_type}", extra={
