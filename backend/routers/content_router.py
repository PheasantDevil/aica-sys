...
async def get_articles(
    ...
    for article in articles:
        article_responses.append(ArticleResponse(
            ...
            tags=article.content_metadata.get('tags', []) if article.content_metadata else [],
            quality_score=article.quality_score,
            status=article.status,
            read_time=article.content_metadata.get('read_time', 5) if article.content_metadata else 5,
