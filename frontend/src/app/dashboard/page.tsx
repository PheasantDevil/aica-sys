      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600">Here's what's happening with your AICA-SyS account.</p>
          </div>
...
function RecentArticles() {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="mt-4">
        <a href="/articles" className="text-sm text-blue-600 hover:text-blue-800 font-medium">
          すべての記事を見る →
        </a>
      </div>
    </div>
