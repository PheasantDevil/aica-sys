...
import { BarChart3, Download, Eye, Star, TrendingDown, TrendingUp, Users } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className={`text-sm ${getChangeColor(analytics.overview.viewsChange)}`}>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className={`text-sm ${getChangeColor(analytics.overview.likesChange)}`}>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">購読者数</p>
                  <p className="text-2xl font-bold">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span
                      className={`text-sm ${getChangeColor(analytics.overview.subscribersChange)}`}
                    >
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">総収益</p>
                  <p className="text-2xl font-bold">
                    ¥{analytics.overview.totalRevenue.toLocaleString()}
                  </p>
                  <div className="flex items-center gap-1 mt-1">
                    {getChangeIcon(analytics.overview.revenueChange)}
                    <span className={`text-sm ${getChangeColor(analytics.overview.revenueChange)}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>閲覧数とエンゲージメントの高い記事</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 border rounded-lg">
                    <p className="text-2xl font-bold">{analytics.newsletterStats.totalSent}</p>
