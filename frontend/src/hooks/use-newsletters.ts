    ...
    placeholderData: () => [
      {
        ...
        description: '今週のTypeScriptエコシステムの重要なアップデートをお届けします。新機能、ライブラリの更新、コミュニティの動向をまとめました。',
        content: '',
      ...
      },
      {
        ...
        description: 'TypeScript 5.0の正式リリースを記念して、新機能の詳細解説と移行ガイドをお届けします。',
        content: '',
      ...
      },
      {
        ...
        description: 'React 18の新機能をTypeScriptと組み合わせて使用する際のベストプラクティスを紹介します。',
        content: '',
      ...
      },
      {
        ...
        description: 'Next.js 14で追加された新機能をTypeScriptで活用する方法を詳しく解説します。',
        content: '',
      ...
      },
      {
        ...
        description: 'TypeScriptの型システムを最大限活用して、より安全なコードを書くための実践的なテクニックを紹介します。',
        content: '',
      ...
      },
      {
        ...
        description: '2024年のTypeScriptエコシステムの主要なトレンドと今後の展望について詳しく分析します。',
        content: '',
