...
import { CheckCircle, Eye, EyeOff, Globe, Key, Shield, Smartphone } from "lucide-react";
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Chrome on macOS • 東京, 日本</p>
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">iOS Safari • 東京, 日本</p>
                <p className="text-xs text-muted-foreground">2024年1月14日 09:15</p>
              </div>
            </div>
