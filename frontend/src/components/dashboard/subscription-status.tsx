      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            <div className="text-gray-500 mb-4">現在サブスクリプションはありません</div>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {isCanceled && <Badge variant="destructive">期間終了時にキャンセル</Badge>}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm">¥{sub.plan?.price?.toLocaleString() || "0"}/月</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>次回請求日: {new Date(sub.current_period_end).toLocaleDateString("ja-JP")}</span>
          </div>
