...
**2.1 Twitter/X API 統合** ⏱️ 1.5 日

- [ ] Twitter Developer アカウント作成
- [ ] API キー取得（v2 API）
- [ ] OAuth 2.0 認証設定
- [ ] Python ライブラリ統合（tweepy）
- [ ] 環境変数設定

**2.2 記事公開時の自動投稿機能** ⏱️ 1 日
...
**2.3 定期自動投稿ワークフロー** ⏱️ 1 日

- [ ] GitHub Actions ワークフロー作成（`social-media-post.yml`）
- [ ] 投稿スケジュール設定
  - 新規記事投稿: 記事生成直後
  - サービス紹介: 週 3 回（月・水・金）
  - トレンド情報: 毎日 1 回
...
**3.1 Google Search Console 設定** ⏱️ 0.5 日
...
**3.2 Google Analytics 設定** ⏱️ 0.5 日
...
| 優先度 | タスク                     | 期限       | 実装期間 | 重要度                     |
| ------ | -------------------------- | ---------- | -------- | -------------------------- |
| 🔴 P0  | Groq API 設定              | 今週中     | 0.5 日   | ★★★★★ 収益化の第一歩       |
| 🔴 P0  | DB マイグレーション実行    | 今週中     | 0.5 日   | ★★★★★ 必須インフラ         |
| 🔴 P0  | テスト記事生成             | 今週中     | 0.5 日   | ★★★★★ システム動作確認     |
| 🔴 P0  | 本番環境デプロイ           | 今週中     | 0.5 日   | ★★★★★ サービス開始         |
| 🔴 P0  | Stripe 本番設定            | 今週中     | 0.5 日   | ★★★★★ 決済開始             |
| 🔴 P1  | Twitter API 統合           | 1 週間以内 | 1.5 日   | ★★★★★ 認知度向上の核       |
| 🔴 P1  | 記事公開時自動投稿         | 1 週間以内 | 1 日     | ★★★★★ トラフィック獲得     |
| 🔴 P1  | 定期自動投稿ワークフロー   | 1 週間以内 | 1 日     | ★★★★☆ 継続的露出           |
| 🔴 P1  | Google Search Console 設定 | 1 週間以内 | 0.5 日   | ★★★★☆ SEO 基盤             |
| 🔴 P1  | OGP 画像最適化             | 1 週間以内 | 0.5 日   | ★★★☆☆ SNS 表示改善         |
