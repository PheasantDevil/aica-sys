...
function printResults() {
  ...
  console.log("============================");
  console.log(
    `Test Duration: ${((testResults.endTime - testResults.startTime) / 1000).toFixed(2)}s`,
  );
  ...
  console.log(
    `Success Rate: ${((testResults.successfulRequests / testResults.totalRequests) * 100).toFixed(
      2,
    )}%`,
  );
